...
class TodoApp extends React.Component {
    ...
    changeTodoInput = (event) => {          //updates with value in input field
        this.setState({ inputData: event.target.value })
    }

    addTodo = (event) => {          //executes when add button is clicked
    ...
    deleteTodo = (index) => {           //executes when x is clicked and removes item
